...
print("""
<form method='post' action='withdraw1.py'><br><br>
<p style="color:black;font-family:arial bold;text-align:center;font-size:200%;"><b><u>WITHDRAW YOUR AMOUNT</u></b></p>
...
<p style="color:black;font-family:arial bold;text-align:center;font-size:150%;">WITHDRAW:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="withdraw" required></p><br><br>
